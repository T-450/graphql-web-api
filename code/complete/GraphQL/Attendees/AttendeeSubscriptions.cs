...
namespace ConferencePlanner.GraphQL.Attendees
{
    ...
    public class AttendeeSubscriptions
    {
        ...
        public SessionAttendeeCheckIn OnAttendeeCheckedIn(
            ...
            [EventMessage] int attendeeId) => new SessionAttendeeCheckIn(attendeeId, sessionId);

        public async ValueTask<ISourceStream<int>> SubscribeToOnAttendeeCheckedInAsync(
            int sessionId,
            [Service] ITopicEventReceiver eventReceiver,
            CancellationToken cancellationToken) => await eventReceiver.SubscribeAsync<string, int>(
