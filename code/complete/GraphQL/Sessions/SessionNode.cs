...
namespace ConferencePlanner.GraphQL.Sessions
{
    ...
    public class SessionNode
    {
        ...
        public Task<Speaker[]> GetSpeakersAsync(
            ...
            CancellationToken cancellationToken) => speakerBySessionId.LoadAsync(session.Id, cancellationToken);

        [UsePaging(ConnectionName = "SessionAttendees")]
        [BindMember(nameof(Session.SessionAttendees), Replace = true)]
        public IQueryable<Attendee> GetAttendees(
            [Parent] Session session,
            [ScopedService] ApplicationDbContext dbContext) => dbContext.Sessions
        ...
        public async Task<Track?> GetTrackAsync(
            ...
            CancellationToken cancellationToken) => session.TrackId is not null
